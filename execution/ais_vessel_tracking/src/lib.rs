...
pub const LNG_TERMINALS: &[&LNGTerminal] = &[
    &HOUSTON_FREEPORT,
    &CAMERON_LNG,
    &PLAQUEMINES_LNG,
];
...
mod tests {
    ...
    fn test_terminal_detection() {
        ...
        assert!(AISStreamClient::is_at_terminal(29.5, -94.5, &HOUSTON_FREEPORT));
        assert!(!AISStreamClient::is_at_terminal(28.0, -95.0, &HOUSTON_FREEPORT));
