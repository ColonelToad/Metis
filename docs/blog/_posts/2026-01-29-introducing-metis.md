...
date: 2026-01-29
author: Researcher
excerpt: "My core thesis: Physical-world constraints in energy systems (storage, production, logistics) create predictable lead times that drive futures prices before traditional market data."
---


## The Core Thesis

Natural gas futures prices are driven by fundamental supply-demand dynamics, but market participants often react *after* the physical facts have materialized. My research focuses on **lead time identification**:
...
I track three categories of lead indicators:
...
My ML model (LSTM) learns these patterns across 10+ years of data and predicts:
...
Traditional traders use price charts, futures curves, and macro data. I'm adding **physical constraints** to the information set—data that's often ignored because it's harder to quantify and less liquid than financial instruments.
...
Stay tuned for deep dives into my methodology, data findings, and real-time performance.
